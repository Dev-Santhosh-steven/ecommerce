...
@section('content')
    <div class="flex items-center justify-between gap-4">
        <div>
            ...
            <p class="mt-2 text-slate-600">Manage all products in the catalog.</p>
        </div>

        <a href="{{ route('admin.products.create') }}" class="rounded-lg bg-slate-900 px-4 py-2 text-sm font-medium text-white">Add Product</a>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 text-sm">
                            <div class="flex gap-2">
                                <a href="{{ route('admin.products.show', $product) }}" class="text-slate-600">View</a>
